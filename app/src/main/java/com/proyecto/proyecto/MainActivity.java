...
public class MainActivity extends AppCompatActivity {
    ...
    private void cargarCategorias() {
        ...
        this.listaeventos.add( new Evento("POP Life! The Pop Culture Festival", "15/12/2021", "Puebla centro, zaragoza 115", "Este festival reúne a través de la música, expositores, conferencias, actividades, fotografía, cine y más, lo mejor de las décadas de los 80´s y 90´s. Fusionamos toda una generación que nos identificó", conferencia) );
        this.listaeventos.add( new Evento("Feria Nacional de Bebidas Típicas 2022", "15/12/2021", "Puebla centro, zaragoza 115", "Este festival se llevará a cabo del 1 al 3 de diciembre en Expo Reforma. Mucho se habla sobre la gastronomía alrededor del mundos", conferencia) );
        this.listaeventos.add( new Evento("FORO FINTECH MÉXICO", "15/12/2021", "Puebla centro, zaragoza 115", "Fintech es un conjunción abreviada de los términos “finanzas” y “tecnología” en inglés y se refiere a cualquier negocio que utilice la tecnología para mejorar o automatizar los servicios y procesos financieros", conferencia) );
        this.listaeventos.add( new Evento("Feria Internacional de Tecnología y Manufactura - FITMA", "15/12/2021", "Puebla centro, zaragoza 115", "La misión de FITMA es la de desarrollar una exposición especializada para el sector metalmecánico, de carácter internacional, que conecte la cadena de suministro de la manufactura global con el rápido crecimiento del mercado industrial de América Latina", conferencia) );
        ...
        this.listaeventos.add( new Evento("Preguntas Frecuentes Expositores", "15/12/2021", "Puebla centro, zaragoza 115", "El Congreso de la UICN, que se celebra cada cuatro años, es el evento de conservación más grande del mundo. Reúne a líderes de gobiernos", conferencia) );
        ...
        this.listaeventos.add( new Evento("Taller informatica", "10/01/2022", "Centro de artes Hidalgo numero 22", "El mundo cambia y las actividades extraescolares también, es fundamental que nuestros hijos cuenten con conocimientos que les permitan salir adelante en el mundo actual, y la informática es uno de ellos.", taller) );
